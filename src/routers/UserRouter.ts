...
class UserRouter {
    ...
    patchRoutes() {
        ...
        this.router.patch('/update/password',UserValidators.updatePassword(),GlobalErrorMiddleWare.checkError,GlobalErrorMiddleWare.authenticate,UserController.updatePassword)
